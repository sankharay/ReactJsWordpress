            ...
            {addresses.length === 0 ? (
                ...
                <ul className="addressblock">
                    {addresses
                        ...
                        .map((location, index) => (
                            <li className="shadow-bottom-right" key={index} onClick={() => onAddressClick(location)}>
                                <div className="locationblock-top-block">
                                    <div className="phoneblock">
                                        <div className="phoneourter map-address-icon-outer">
                                            <a href={`tel:${location.contactNumber}'`} >
                                                <Phone className="icon-colors-orange" />
                                                </a>
                                        </div>
                                        <div className="bottom-text">CALL</div>
                                    </div>
                                    <div className="directions">
                                        <div className="directionouter map-address-icon-outer">
                                            <LocationOn className="icon-colors-orange" />
                                        </div>
                                        <div className="bottom-text">Direction</div>
                                    </div>
                                    <div className="website">
                                        <div className="websiteourter map-address-icon-outer">
                                        <a href={`https://${location.url}`} target="_blank" rel="noopener noreferrer">
                                            <Language className="icon-colors-orange" />
                                        </a>
                                        </div>
                                        <div className="bottom-text">Website</div>
                                    </div>
                                </div>
